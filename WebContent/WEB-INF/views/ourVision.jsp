...
<!-- Navigation end -->
	...
	<div class="about-text">
		<p>
			iPerformKonnect is a Cloud based, Multi platform, Device
			independent learning zone creating customized learning, based on the
			ability of an individual student.
		</p>
	</div>
	<!-- MAIN TEXT -->
...
<div class="container">
	<div class="col-md-6 col-sm-12 col-xs-12 pull-left" style="margin-top:20px;">
		<h2>A personalized learning resource </h2>
	</div>
</div>
	...
	<div class="container marketing">
		...
		<div class="row">
			<div class="col-md-9 col-sm-5 col-xs-6 text-justify select-topic ">
				
<p>
		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis eget metus in lectus pretium vestibulum ut
	in enim. Nunc convallis ante ac dictum rutrum. Quisque lobortis risus elit. Quisque ut ullamcorper
					  tellus. Sed ornare dignissim augue aliquet rhoncus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis eget metus in lectus pretium vestibulum ut
	in enim. Nunc convallis ante ac dictum rutrum. Quisque lobortis risus elit. Quisque ut ullamcorper
				</p>
			</div>
			<div class="col-md-3 col-sm-5 col-xs-6 text-center select-topic" style="padding-top:0px;">
				
<img src="${pageContext.request.contextPath}/resources/images/creating.png" class="pull-center" alt="" title="" style="max-width: 100% !important;"/>
			</div>
		</div>
	</div>
	<!-- HOW DO WE LEARN -->
...
<ul>
<li>
<strong>Well established video CMS</strong>
<br>
ViMP is being developed continuously for more than 7 years now.
</li>
<li>
<strong>
Flexible
...
ViMP can be adapted easily to your current systems.
<strong>
<br>
</strong>
</li>
...
Complete control over content and user data base.
</li>
<li>
<strong>
...
ViMP can be extended and customized easily due to its modular architecture.
</li>
</ul>
			</div>
			<div class="col-md-3 col-sm-5 col-xs-6 text-center select-topic" style="padding-top:0px;">
				
<img src="${pageContext.request.contextPath}/resources/images/abut-bg2.png" class="pull-center" alt="" title="" style="max-width: 100% !important;"/>
			</div>
		</div>
	</div>
	<!-- HOW DO WE LEARN -->
