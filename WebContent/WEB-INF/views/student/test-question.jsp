    ...
    <div class="box box-solid " style="height:auto;">
        <div class="box-body">
            ...
            <c:choose>
                ...
                <c:when test="${question.hinttypeid=='3'}">
                 <a class="example-image-link" href="${lmsimagepath}${question.hintContent}" data-lightbox="example-1">
                    <img src="${lmsimagepath}${question.hintContent}" width="100%" height="100%"/>
...
<c:choose>
    <c:when test="${not empty question}">
                ...
                <c:forEach var="answer" items="${question.answers}"
                    ...
                    <li class="list-group-item"  id="${answer.id}" userres="0"  divid="question${question.id}"  ic='${ic}'
                        ...
                        for="${answer.id}"> ${answer.getDescription()}</label> <c:if
                            ...
                            <a class="example-image-link" href="${lmsimagepath}${answer.imagePath}" data-lightbox="example-1">
                            <img src="${lmsimagepath}${answer.imagePath}" alt="" />
        ...
        <div class="box box-success box-solid" id="explanationid"
            ...
            <div class="box-body" id="benefits${question.id}${val}" style="display: block;">
                ...
                <div id="upbutton label" style="width:100px">
...
<button  data-toggle="modal" data-target="#myModal" style="display:none;" id="buttontesting"></button>
<button  data-toggle="modal" data-target="#myModal1" style="display:none;" id="buttontesting1"></button>
<button  data-toggle="modal" data-target="#myModal2" style="display:none;" id="buttontesting2"></button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <img width="25" height="25" src=" ${pageContext.request.contextPath}/resources/images/wrong.png"/>
          </button>
        <!--   <h4 class="modal-title">Modal Header</h4> -->
        </div>
        <p style="text-align:center;color:#000;padding:5px;">"Well Done !!!, Please read explanation and go to Next question"</p>
         <p style="text-align:center;">
         <img width="70" height="70" src="${pageContext.request.contextPath}/resources/images/welldone-emozi.png"/>
         </p>
      </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content1">
       ...
       <!--    <h4 class="modal-title">Modal Header</h4> -->
        ...
        <p style="text-align:center;color:#000;padding:5px;">"Sorry Incorrect attempt !!!, Please go through the resource and try again"</p>
       
        <p style="text-align:center;">
     
        <img width="70" height="70" src="${pageContext.request.contextPath}/resources/images/Sorry-try-again.png"/>
         </p>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content2">
       ...
       <!--    <h4 class="modal-title">Modal Header</h4> -->
        ...
        <p style="text-align:center;color:#000;padding:5px; margin-bottom:0px;">"Ohh, Again Incorrect attempt !!!, No issues please go through the Explanation and try Next question" </p>
        <p style="text-align:center;">
...
var gscore='${score}';
var checkCorrectStatus=false;
var countForCurrectOrincorrectAttampts=0;
if(gscore<40)
    {
    ...
    $(".list-group-item").on("click", function() {
        ...
        if (checkCorrectStatus==false || checkCorrectStatus=='false'){
        ...
        for (var t = $("#" + e).attr("ic"), s = document.getElementById("ulcontainer").children, n = s.length, a = 0; n > a; a++) "li" == s[a].nodeName.toLowerCase() && $("#" + s[a].id).css("background", "#ffffff").css("border", "1px solid #ddd");
        1 == t || "1" == t ? $(this).css("background", "#00A65A") : (0 == t || "0" == t) && $(this).css("background", "#f27979"), userValues = $(this).attr("id");
        var o = $(this).attr("ic");
        1 == o || "1" == o ? (isAttempted = 1, isCorrect = 1, correctCount++, trueclickCount++, countdemo++, document.getElementById("explanationid").style.display = "block") : (isAttempted = 1, isCorrect = 0, falseclickCount++, countdemo++, document.getElementById("explanationid").style.display = "block"), (1 == question_new_old || "1" == question_new_old) && (questioid = "count_" + incrimentForQuestiion + "_QID_${question.id}", $("#questStatusId").append('<span data-toggle="tooltip" title="" id="' + questioid + '"  class=""  data-original-title=""></span>'), question_new_old = 0), 1 == isAttempted && 1 == isCorrect && (2 == trueclickCount && 2 == countdemo ? document.getElementById(questioid).className = "badge bg-green quest_cir" : (document.getElementById(questioid).className = "badge bg-blue quest_cir", isCorrect = 2)), 1 == isAttempted && 0 == isCorrect && (document.getElementById(questioid).className = "badge bg-red quest_cir")
        }})
...
///////////////////////dddddddddddddddddddddddddddddddddddddddddddddddddd==========================================================
      ...
      $(".list-group-item").on("click", function() {
        ...
        if (0 != isSelect && "0" != isSelect) return alert("Correct Answer !"), !1;
        flag = !0;
        var ecor = $(this).attr("ic")
       

           
        if(ecor==1){
            checkCorrectStatus=true;
            $("#buttontesting").trigger('click');
                //document.getElementById('myModal').className = "modal-content";
               
        }
        else
            {
           
            $("#buttontesting1").trigger('click');
           
            if(countForCurrectOrincorrectAttampts==1){checkCorrectStatus=true;}
            countForCurrectOrincorrectAttampts++;
            // alert("INCorrect Answer !")explanationid
            document.getElementById("explanationid").style.display = "none";
                ...
                if(ecor==1){
                //alert("Please press the next button for mor Question..!");
                }else{
                      $("#buttontesting2").trigger('click');
                      document.getElementById("explanationid").style.display = "block";
                    //alert("Sorry..! No attampts are remaining . Please press the next button for mor Question.");
...
//////////////////////////////////////////////dhiraj-========//////////////////////////////////////////////////////////////////////////////////
    ...
    $(".list-group-item").on("click", function() {
        ...
        var e = $(this).attr("ic"),
            t = $(this).attr("id");
        1 == e || "1" == e ? (isAttempted = 1, isCorrect = 1, correctCount++, document.getElementById("explanationid").style.display = "block") : (isAttempted = 1, isCorrect = 0, document.getElementById("explanationid").style.display = "block"), isSelect++, $(this).css("background", "#f68929").css("border", "2px solid #cf6f1a");
