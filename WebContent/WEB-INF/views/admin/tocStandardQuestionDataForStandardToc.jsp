					...
					<div class="col-md-12">
						<div class="row">
							...
							<div class="edit-quest">
								...
								<form:form action="${pageContext.request.contextPath}/admin/uploadQuestion.htm"  method="POST" modelAttribute="globalVO" enctype="multipart/form-data" id="questionFormId" >
