<html>
	...
	<body>
		<h2 class="text-center">Update Existing Questions via Excel Sheet!!</h2>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Update Questions from Excel</h4>
				</div>
	
				<div class="clearfix"></div>
				<div class="modal-body" style="border-bottom: none !important">
					<span id="studentExcelId"></span>
					<form id="questionUploadForm" method="post" action="${pageContext.request.contextPath}/admin/updateExistingQuestions.htm" enctype="multipart/form-data">
						<!-- File input -->
						<input name="questionExcel" id="excelFileId" type="file" /><br />
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body" style="border-bottom: none !important">
					...
					<div style="text-align:center"><a class="btn btn-warning" href="${pageContext.request.contextPath}/admin/downloadExistingQuestionFormat">Download</a></div>
				</div>
			</div>
		</div>
	</div>
