			...
			<div class="container fix">
				<div class="row">
					...
					<div class="col-md-12 col-xs-12">
														     ...
														     <c:otherwise>			<!-- For rest of user types -->
														      	<li id="masterToc">
															         ...
															         <ul class="dropdown-menu" role="menu">
																		...
																		<li><a href="${pageContext.request.contextPath}/admin/getChapterTocPage_SME.htm">Chapter Details</a></li>
															            <li><a href="${pageContext.request.contextPath}/admin/getTopicTocPage_SME.htm">Topic Details</a></li>
															           
															              <li><a href="${pageContext.request.contextPath}/admin/getTopicTocStandardLOPage_SME.htm">Learning Objects</a></li>
															               <li><a href="${pageContext.request.contextPath}/admin/questionPage_SME.htm">Questions</a></li>
						...
						<c:if test="${sessionScope.user.userType eq 6 }">
