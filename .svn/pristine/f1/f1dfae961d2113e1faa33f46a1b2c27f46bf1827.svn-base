...
<!-- Navigation end -->
	...
	<div class="container marketing">
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-7" style="padding:0px;">

				<img  src="${pageContext.request.contextPath}/resources/images/logo-big.jpg" alt="">

				</div>


			<div class="col-md-8 col-sm-6 col-xs-7 select-topic" style="text-align:justify">
...
<p>Classteacher has been empowering technology solutions for schools in the K-12 segment for more than 12 years. One of the first companies in India to introduce Digital White Boards; develop and introduce digital content and Classpad Tablets, Classteacher Learning Systems is the only company to have a complete range of solutions in Digital Interactive Classroom Program, Classpad, Assessment Program, Digital Math Program, Digital Science Program, Online Program and Digital Language Program. </p>
<p><strong>Our fundamental beliefs that inform and drive the innovation process:</strong></p>
<ul>
<li>Voluntary learner participation is critically linked to superior learning outcomes</li>
<li>The teacher plays a pivotal role as a mentor, facilitator and interpreter of reality</li>
<li>Technology and tools must support the primary pedagogic agenda and not vice versa</li>
</ul>
			</div>
	...
	<!-- /END THE FEATURETTES -->
<div class="green-bg"style="background-color:#ffffff;">
<div class=" how-add" style="margin:auto; float:none">
<h2 class="text-center" style="color:#ffffff; padding-bottom:20px;padding-top:20px; ">Experience the power of technology innovation in education, with incredible Classteacher products. </h2>
</div>
<h2 class="text-center" style="padding-bottom:20px;padding-top:20px; background-color:#DDDDDD;">Our innovative and interactive solutions for schools and students are created for all platforms.</h2>
	<div class="container">
	 ...
	 <div class="col-sm-4">
                  ...
                  <div class="ih-item square colored effect10 left_to_right"><a href="#">
                      <div class="img"><img
					src="${pageContext.request.contextPath}/resources/images/about-btm1.png"
					title="" alt="" /></div>
                      <div class="info">
                        <h3>Multi User Platform</h3>
					<p>
               ...
               <div class="col-sm-4">
                  ...
                  <div class="ih-item square colored effect10 left_to_right"><a href="#">
                      <div class="img"><img
					src="${pageContext.request.contextPath}/resources/images/about-btm2.png"
					title="" alt="" /></div>
                      <div class="info">
                       <h3>Cloud-based product</h3>
					<p>
                ...
                <div class="col-sm-4">
                  ...
                  <div class="ih-item square colored effect10 left_to_right"><a href="#">
                      <div class="img"><img
					src="${pageContext.request.contextPath}/resources/images/about-btm3.png"
					class="pull-left" title="" alt="" /></div>
                      <div class="info">
                       <h3>Built in analytics</h3>
					<p>
						We are offering guided learning based<br> on Spaced which is
