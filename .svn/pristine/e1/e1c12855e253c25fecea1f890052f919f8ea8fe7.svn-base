...
CKEDITOR.replace( 'editor1', { toolbar : [ [ 'EqnEditor', 'Bold', 'Italic','Source',"Save","NewPage","DocProps","Preview","Print"
,"Templates","document","Cut","Copy","Paste","PasteText","PasteFromWord","Undo","Redo","Find","Replace","SelectAll","Scayt",
"Form","Checkbox","Radio","TextField","Textarea","Select","Button","ImageButton","HiddenField","Underline", "Strike","Subscript",
 "Superscript","RemoveFormat","NumberedList","BulletedList","Outdent","Indent","Blockquote","CreateDiv","JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock","BidiLtr","BidiRtl","Link", "Unlink","Anchor","CreatePlaceholder","Image","Flash"
 ,"Table","HorizontalRule","Smiley","SpecialChar","PageBreak","Iframe","InsertPre","Styles","Format","Font","FontSize","TextColor", "BGColor","UIColor","Maximize","ShowBlocks","button1" ,"button2","button3","oembed","MediaEmbed","About"

 ] ] });
</script>

<div class="col-md-2" style="margin:10px; padding-left:4%">
<button class="btn btn-success "  onclick="backQuestion()">Back</button>
		<br><br>
</div>

<div class="col-md-2" style="margin:10px; padding-left:4%">
<button class="btn btn-success "  onclick="addQuestion()">Add New</button>
		<br><br>
</div>

<div class="modal-body assign-name-pop-mid panel-body2" id="addquestionscreen1234"  style="width:95%; margin:10px; padding-left:4%">
	...
	<br><br>
							...
							<div class="new-question">
									...
									<div class="col-md-3 col-sm-3">
										<select id="questionLearnZoneId"
											name="questionLearnZoneId" required="required">
											<option value="">Zone Level</option>
												<option value="17">learn level</option>
												<option value="18">practice level</option>
												<option value="19">mastery level</option>
									...
									<input type="hidden" name="loId" id="loId" value="${selectedlo}" />
								...
								<div class="col-md-12 col-sm-12 mrt20" style="border-bottom: solid 1px #ccc; margin-bottom:15px;">
...
<div class="col-md-12 col-sm-12 mrt20" style="border-bottom: solid 1px #ccc; margin-bottom:15px;">
								...
								<div class="col-md-2 col-sm-2 col-xs-12 ques-file-fld">
									...
									<div class="col-md-12 col-sm-12 mrt20" style="margin-bottom:15px;">
								<div class="clearfix"></div>
									<span class="errorCls2" style="color: red;"></span>
									<br>
								<div class="col-md-2 mrt20">
									<div class="col-md-2 mrt20"><a href="javascript:void(0)" class="btn btn-danger" id="updateQuestionId">Submit Question</a></div>
								</div>
								
								<!-- <div class="col-md-2 mrt20">
									<div class="col-md-2 mrt20"><a href="javascript:void(0)" class="btn btn-danger" id="previewQuestionId">Preview Question</a></div>
								</div> -->
							</div>
...
<div style="width:90%;margin:0px auto;" id="questiondataaa">
	<div>
