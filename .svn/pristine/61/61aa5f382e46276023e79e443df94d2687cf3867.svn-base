				...
				<div class="thumbnail">
					<div class="caption">
						...
						<div class="ih-item circle effect1">
							...
							<a href="${pageContext.request.contextPath}/schoolTeacher/getManageTocHome.htm">
								<div class="spinner"></div>
								<div class="img" style="width: 89%;">
									<img
										src="${pageContext.request.contextPath}/resources/images/1.jpg" style="max-width:100%">
								</div>
								<div class="info">
									<div class="info-back">
     <p style="margin:0px; padding:46px 15px;"> View Table of content browse through resources & add self-created content in various formats.</p> 
									</div>
								</div>
					...
					<div class="caption">
						...
						<div class="ih-item circle effect1">
							...
							<a
								...
								<div class="img" style="width: 89%;">
									<img
										src="${pageContext.request.contextPath}/resources/images/3.jpg" style="max-width:100%;">
								</div>
								<div class="info">
									<div class="info-back">
									<p style="margin:0px; padding:46px 15px;">Choose Questions, set test parameters and publish test to the students.</p>
									</div>
								</div>
					...
					<div class="caption">
						...
						<div class="ih-item circle effect1">
							...
							<a
								...
								<div class="img" style="width: 89%;">
									<img
										src="${pageContext.request.contextPath}/resources/images/4.jpg" style="max-width:100%;">
								</div>
								<div class="info">
									<div class="info-back">

										  <p style="margin:0px; padding:46px 15px;">Assign test, topic and resources to the students</p> 
									</div>
								</div>
					...
					<div class="caption">
						...
						<div class="ih-item circle effect1">
							...
							<a href="${pageContext.request.contextPath}/schoolTeacher/getAssessmentReports.htm">
								...
								<div class="img" style="width: 89%;">
									<img
										src="${pageContext.request.contextPath}/resources/images/2.jpg" style="max-width:100%;">
								</div>
								<div class="info">
									<div class="info-back">
									<p style="margin:0px; padding:46px 15px;">View Exhaustive set of reports to have better insight of proficiency among students</p>
									</div>
								</div>
										...
										<table class="table table-bordered table-hover table-striped">
											<thead>
												<tr>
													...
													<th>Test Name</th>
													<th>No. of Students <br>
													(Students attempted/student assigned)</th>
													<th>Average Score </th>
													<th>Maximum Marks</th>
									...
									<div class="list-group">
										<c:forEach items="${upcomingTestList}" var="assessmentUp">
											<a href="#" class="list-group-item"> <c:choose>
												...
												${assessmentUp.grade.name}, Task name-${assessmentUp.testName}, Maximum marks-${assessmentUp.maxMarks}, Start date-&nbsp;<fmt:formatDate
