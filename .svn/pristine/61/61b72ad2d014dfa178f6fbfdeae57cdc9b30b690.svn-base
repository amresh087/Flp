	...
	<head>
		...
		<script>
			function getChapterData()
			{
				...
				$('#fullPageloader').show();
				$('#chapterDataId').empty().load('${pageContext.request.contextPath}/admin/getChapterDataTocPage/'+$('#sectionId option:selected').attr("gradeid")+'/'+$('#subjectId').val()+'.htm',function()
				{
					$('#fullPageloader').hide();
				});
			}
