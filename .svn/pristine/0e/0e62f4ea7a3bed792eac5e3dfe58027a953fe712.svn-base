...
<div style="width:90%;margin:0px auto;" id="showHideId">
	<div>
		...
		<button class="btn btn-success " data-toggle="modal" data-target="#module-resources" onclick="addModule()">Add Resources</button>
		<br><br>
					...
					<table id="dataTableId" class="display" style="width:100%">
						...
						<tbody>
							<c:forEach var="moduleTopic" items="${moduleTopicList}" varStatus="status">
								...
								<td>
								<c:choose><c:when test="${moduleTopic.module.contentType eq 1 || moduleTopic.module.contentType eq 3  }">
									<a href="${commonPath}/modules/${moduleTopic.module.contentUrl}" target="_blank">
											<c:choose>
									...
									<c:if test="${moduleTopic.module.contentType eq 2}">
	...
	<!-- Module resources -->
	<div id="module-resources" class="modal fade" role="dialog">
		<div class="modal-dialog">
